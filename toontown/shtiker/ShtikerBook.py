...
class ShtikerBook(DirectFrame, StateData.StateData):
    ...
    def load(self):
        ...
        self.resetFrameSize()
        self.bookOpenButton = DirectButton(image=(bookModel.find('**/BookIcon_CLSD'), bookModel.find('**/BookIcon_OPEN'), bookModel.find('**/BookIcon_RLVR')), parent=base.a2dBottomRight, relief=None, pos=(-0.165, 0, 0.17), scale=0.305, command=self.__open)
        self.bookCloseButton = DirectButton(image=(bookModel.find('**/BookIcon_OPEN'), bookModel.find('**/BookIcon_CLSD'), bookModel.find('**/BookIcon_RLVR2')), parent=base.a2dBottomRight, relief=None, pos=(-0.165, 0, 0.17), scale=0.305, command=self.__close)
