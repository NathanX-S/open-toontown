...
class LocalToon(DistributedToon.DistributedToon, LocalAvatar.LocalAvatar):
    ...
    def __init__(self, cr):
        try:
            ...
            self.bFriendsList = DirectButton(image=(friendsButtonNormal, friendsButtonPressed, friendsButtonRollover), relief=None, parent=base.a2dTopRight, pos=(-0.14, 0, -0.125), scale=newScale, text=('', TTLocalizer.FriendsListLabel, TTLocalizer.FriendsListLabel), text_scale=0.09, text_fg=Vec4(1, 1, 1, 1), text_shadow=Vec4(0, 0, 0, 1), text_pos=(0, -0.185), text_font=ToontownGlobals.getInterfaceFont(), command=self.sendFriendsListEvent)
    ...
    def initInterface(self):
        ...
        if self.style.getAnimal() == 'monkey':
            self.laffMeter.setPos(0.12, 0.0, 0.13)
        else:
            self.laffMeter.setPos(0.14, 0.0, 0.13)
        self.laffMeter.stop()
